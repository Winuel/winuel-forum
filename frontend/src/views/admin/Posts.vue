<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">帖子管理</h1>
            ...
            <tr v-else v-for="post in posts" :key="post.id">
              <td class="px-6 py-4">
                <div class="flex items-start">
                  <div v-if="post.pinned" class="flex-shrink-0 mt-1">
                    <svg class="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6.053c0 .452.546.684.858.37l3.29-3.093c.34-.32.34-.842 0-1.162l-3.29-3.093A.5.5 0 0014 9z" />
                    </svg>
                  </div>
                  <div class="ml-2">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span
                  ...
                  :class="post.deleted_at ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' : 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'"
                >
                  {{ post.deleted_at ? '已删除' : '正常' }}
                </span>
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end space-x-2">
                  <button
                    ...
                    :class="post.pinned ? 'text-yellow-600 hover:text-yellow-900 dark:text-yellow-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400'"
                    :title="post.pinned ? '取消置顶' : '置顶'"
                  >
                    <svg class="w-5 h-5" :class="post.pinned ? 'fill-current' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
